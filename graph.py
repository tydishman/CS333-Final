...
def generate_graphs():
    ...
    fig_pie.update_layout(title_text="Spending Breakdown (Pastel Brown & Green Gradient)")
    ...
    fig_bar.update_layout(title_text="Budget vs. Actual Spending", yaxis_title="Amount ($)")
