...
category_recommendations = {
    ...
    "Entertainment": 0.10,  # Recommended 10% for entertainment
...
def get_budget_tips(income, rent, food, entertainment, savings):
    ...
    **User's Financial Data:**
    ...
    - Entertainment should be around 10% of income
...
def analyze_spending(user_income, user_rent, user_food, user_entertainment, user_savings):
    ...
    recommended_entertainment = user_income * category_recommendations["Entertainment"]
    ...
    entertainment_analysis = "good" if user_entertainment <= recommended_entertainment else "too high"
    savings_analysis = "good" if user_savings >= recommended_savings else "too low"

    return {
        "Rent": rent_analysis,
        "Food": food_analysis,
        "Entertainment": entertainment_analysis,
...
if __name__ == "__main__":
    ...
    spending_analysis = analyze_spending(user_income, user_rent, user_food, user_entertainment, user_savings)
